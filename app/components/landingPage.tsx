...
import { ChevronRight, Activity, Database, Check, Droplets, FlaskConical, LineChart, Shield, User, Mail, BookOpen } from "lucide-react";
...
const ScrollReveal = ({ children, delay = 0 }) => {
  ...
  return (
    <div ref={ref} className="opacity-0 translate-y-8 transition-all duration-1000">
      {children}
    </div>
  );
};
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto animate-fade-in-delayed-2">
              Combining Hyperspectral Imaging with AI for Precise Oil Quality Analysis
            </p>
            <div className="flex gap-4 justify-center animate-fade-in-delayed-3">
              <button className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 rounded-lg 
                font-semibold flex items-center gap-2 transition-all hover:transform hover:scale-105">
                Start Analysis
                <ChevronRight size={20} />
              </button>
              <button className="border border-orange-600 hover:bg-orange-600/10 text-white px-8 py-4 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-16">
              <h2 className="font-display text-4xl font-bold mb-6">Our Process</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="bg-black/50 p-8 rounded-2xl border border-orange-900/30 hover:border-orange-500/50 transition-all duration-300">
                  <div className="mb-6">{process.icon}</div>
                  <h3 className="font-display text-xl font-semibold mb-4 text-orange-400">{process.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl font-bold mb-8 text-orange-400">Advanced Spectral Analysis</h2>
                <p className="text-gray-300 text-lg mb-8">
                  Our system utilizes cutting-edge hyperspectral imaging technology to analyze oil samples 
                  across multiple wavelengths, creating detailed chemical fingerprints for authentication.
                </p>
          ...
          <ScrollReveal>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="bg-black/50 p-8 rounded-2xl border border-orange-900/30">
                <h3 className="font-display text-xl font-semibold mb-4 text-orange-400">Scientific Publications</h3>
                <div className="space-y-6">
                  <div className="space-y-2">
                    <h4 className="font-semibold">Advanced Spectral Analysis in Food Safety</h4>
                    <p className="text-gray-400">Journal of Food Science, 2024</p>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-semibold">Machine Learning in Oil Authentication</h4>
                    <p className="text-gray-400">IEEE Transactions on Food Safety, 2024</p>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-semibold">Hyperspectral Imaging Applications</h4>
                    <p className="text-gray-400">Food Chemistry, 2023</p>
                  </div>
                </div>
              </div>
              <div className="bg-black/50 p-8 rounded-2xl border border-orange-900/30">
                <h3 className="font-display text-xl font-semibold mb-4 text-orange-400">Research Highlights</h3>
                <ul className="space-y-4">
                  <li className="flex gap-3">
                    <Check className="text-orange-400 flex-shrink-0 mt-1" />
                    <div>
                      <span className="font-semibold">Novel Algorithm Development</span>
                      <p className="text-gray-400">Advanced machine learning models for spectral data analysis</p>
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <Check className="text-orange-400 flex-shrink-0 mt-1" />
                    <div>
                      <span className="font-semibold">Database Enhancement</span>
                      <p className="text-gray-400">Extensive spectral database of pure and adulterated oils</p>
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <Check className="text-orange-400 flex-shrink-0 mt-1" />
                    <div>
                      <span className="font-semibold">Hardware Optimization</span>
                      <p className="text-gray-400">Improved hyperspectral imaging system design</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="bg-black/50 p-8 rounded-2xl border border-orange-900/30 hover:border-orange-500/50 transition-all duration-300">
                  ...
                  <h3 className="font-display text-xl font-semibold mb-4 text-orange-400">{app.title}</h3>
                ...
                <ScrollReveal key={index} delay={index * 200}>
                  <div className="bg-black/50 p-8 rounded-2xl border border-orange-900/30 
                    ...
                    <div className="flex flex-col items-center text-center">
                      <div className="mb-6 p-4 bg-orange-900/20 rounded-full">
                        {member.icon}
                      </div>
      ...
      <footer className="py-8 bg-black border-t border-orange-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-gray-400">
            <Droplets size={32} className="text-orange-500 mx-auto mb-4 hover:scale-110 transition-transform duration-300" />
